...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        //CONSTRUTOR CHEIO
        Aluno aluno01 = new Aluno(1 ,"THIAGO" , "1111-1111");
        Aluno aluno02 = new Aluno(2 ,"MARLON" , "2222-2222");
        Aluno aluno03 = new Aluno(3 ,"MATHEUS", "3333-3333");
        Aluno aluno04 = new Aluno(4 ,"LUCAS"  , "4444-4444");
        Aluno aluno05 = new Aluno(5 ,"ROGERIO", "5555-5555");
        ...
        Aluno aluno09 = new Aluno(9 ,"GABRIELA"   , "9999-9999");
        Aluno aluno10 = new Aluno(10,"MARCOS"   , "1010-1010");
